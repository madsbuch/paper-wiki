...
export const meta = {
  ...
  description: "Build a practical few-shot learning system using prompt engineering techniques. Learn how to select examples, design templates, and integrate chain-of-thought reasoning for better performance.",
