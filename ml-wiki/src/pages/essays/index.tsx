        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex gap-6">
              ...
              <Link to="/essays" className="text-violet-600 font-semibold">
                Essays
              </Link>
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div className="flex-1">
                      <h2 className="text-3xl font-bold text-slate-900 group-hover:text-emerald-600 transition-colors mb-3">
                        {essay.title}
                      </h2>
                    ...
                    <svg
                      className="w-6 h-6 text-slate-400 group-hover:text-emerald-600 transition-colors shrink-0 mt-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
