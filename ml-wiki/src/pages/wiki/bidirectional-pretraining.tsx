  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">The Breakthrough</h2>
          <p className="text-slate-700">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">Why Bidirectional Matters</h2>
          <p className="text-slate-700 mb-4">
            Consider the sentence: "The bank by the river was flooded."
          </p>
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li><strong>Left-to-right only</strong>: When processing "bank," the model only sees "The"</li>
            <li><strong>Bidirectional</strong>: The model sees both "The" before and "by the river" after, understanding "bank" means riverbank, not a financial institution</li>
          </ul>
          <p className="text-slate-700">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">A Story About Context</h2>
          <p className="text-slate-700">
        ...
        <p className="text-slate-700">
          <strong>Related Concepts:</strong> <a href="/wiki/masked-language-model" className="text-blue-600 hover:underline">Masked Language Model</a> · <a href="/wiki/transfer-learning" className="text-blue-600 hover:underline">Transfer Learning</a>
        </p>
      </div>
    </WikiLayout>
  );
