  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">The Two-Stage Paradigm</h2>
          <p className="text-slate-700 mb-4">
            Modern NLP follows a two-stage approach:
          </p>
          <ol className="list-decimal list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li><strong>Pretraining</strong>: Train on large amounts of unlabeled data to learn general language representations</li>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">A Simple Analogy</h2>
          <p className="text-slate-700">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-4">The BERT Approach</h2>
          <p className="text-slate-700">
        ...
        <p className="text-slate-700">
          <strong>Related Concepts:</strong> <a href="/wiki/transfer-learning" className="text-blue-600 hover:underline">Transfer Learning</a> · <a href="/wiki/bidirectional-pretraining" className="text-blue-600 hover:underline">Bidirectional Pretraining</a> · <a href="/wiki/masked-language-model" className="text-blue-600 hover:underline">Masked Language Model</a>
        </p>
      </div>
    </WikiLayout>
  );
