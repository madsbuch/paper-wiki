...
export default function ParameterEfficientFineTuningPEFT() {
  ...
  const meta = {
    ...
    description:
      "Techniques for adapting large pre-trained models to downstream tasks while training only a small fraction of parameters",
      ...
      <div className="space-y-6">
        <section>
          <p className="text-slate-700 mb-4">
            <strong>Parameter-Efficient Fine-Tuning (PEFT)</strong> refers to a
            family of techniques for adapting large pre-trained models to
            downstream tasks while training only a small fraction of the model's
            parameters. These methods address the computational and storage
            challenges of traditional fine-tuning as models scale to hundreds of
        ...
        <section>
          ...
          <p className="text-slate-700 mb-4">
            This approach becomes prohibitively expensive for very large models
            [Hu et al., 2021, p.1]:
          </p>
          <p className="text-slate-700 mb-2">
            <strong>For GPT-3 175B:</strong>
          </p>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li>
              <strong>Freezing</strong> the pre-trained model weights
            </li>
            <li>
              Training only a{" "}
              <strong>small set of additional or selected parameters</strong>
            </li>
            <li>
        ...
        <section>
          ...
          <p className="text-slate-700 mb-4">
            <strong>Concept:</strong> Insert small neural network modules
            (adapters) between layers of the pre-trained model.
          </p>
          <p className="text-slate-700 mb-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 mb-4">
            ...
            <li>
              Only train the adapter parameters while freezing the original
              model
            </li>
            <li>
              Typically 2 fully-connected layers with a nonlinearity between
              them
            </li>
          </ul>
          <p className="text-slate-700 mb-2">
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 mb-4">
            <li>
              <strong>AdapterH</strong> (Houlsby et al., 2019): Two adapters per
              Transformer block
            </li>
            <li>
              <strong>AdapterL</strong> (Lin et al., 2020): One adapter per
              block, after MLP module
            </li>
            <li>
              <strong>AdapterP</strong> (Pfeiffer et al., 2021): Similar to
              AdapterL with additional LayerNorm
            </li>
          </ul>
          ...
          <p className="text-slate-700 mb-4">
            <strong>Concept:</strong> Add trainable "prefix" or "prompt" tokens
            to the input or intermediate activations.
          </p>
          <p className="text-slate-700 mb-2">
            <strong>Variants:</strong>
          </p>
          <div className="space-y-4 mb-4">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 text-sm">
                <li>
                  Prepends learnable continuous "soft prompt" embeddings to the
                  input
                </li>
                <li>
                  Only these prompt embeddings are trainable (~20k params for
                  11B model)
                </li>
                <li>
                  Performance scales with model size: matches full fine-tuning
                  for models &gt;10B params
                </li>
                <li>
                  Simpler than prefix tuning, only modifies input rather than
                  every layer
                </li>
              </ul>
              <p className="text-slate-700 text-sm italic mt-1">
                [Lester et al., 2021, p.1-2]
              </p>
            </div>
            <div>
              <p className="text-slate-700 font-semibold mb-1">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 text-sm">
                <li>
                  Extends prefix-embedding by making activations trainable at
                  every layer
                </li>
                <li>
                  Instead of letting representations evolve naturally, replace
                  them with trainable vectors
                </li>
              </ul>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="bg-green-50 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-slate-700 text-sm">
                ...
                <li>
                  <strong>Prompt tuning</strong>: Scales excellently with model
                  size [Lester et al., 2021]
                </li>
                <li>
                  <strong>Prompt tuning</strong>: Better domain transfer
                  robustness than full fine-tuning
                </li>
              </ul>
            </div>
            <div className="bg-red-50 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-slate-700 text-sm">
                ...
                <li>
                  <strong>Prefix methods</strong>: Performance can be unstable
                  and "changes non-monotonically"
                </li>
                <li>
                  <strong>Prefix methods</strong>: Difficult to optimize,
                  especially on small datasets
                </li>
                <li>
                  <strong>Prefix methods</strong>: Poor performance in low-data
                  regimes (e.g., 37.6% on MNLI-100 vs 63.8% for LoRA)
                </li>
                <li>
                  <strong>Prompt tuning</strong>: Gap with full fine-tuning
                  larger for models &lt;10B params
                </li>
              </ul>
            </div>
          </div>
          ...
          <p className="text-slate-700 text-sm italic">
            [Hu et al., 2021, p.3, 6, 23; Lester et al., 2021, p.1-7]
          </p>
          ...
          <p className="text-slate-700 mb-4">
            <strong>Concept:</strong> Inject trainable low-rank decomposition
            matrices in parallel to existing weights.
          </p>
          <p className="text-slate-700 mb-2">
            <strong>How it works:</strong>
          </p>
          ...
          <p className="text-slate-700 mb-4">
            <strong>Concept:</strong> Train only the bias vectors while freezing
          ...
          <p className="text-slate-700 mb-4">
            <strong>Concept:</strong> Train only specific layers or modules
          ...
          <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 mb-4">
            <li>
              <strong>FTTop2</strong>: Train only the top 2 layers of the model
            </li>
            <li>
        ...
        <section>
          ...
          <p className="text-slate-700 mb-2">
            <strong>T5-XXL (11B params) on SuperGLUE:</strong>
          </p>
          ...
          <p className="text-slate-700 text-sm italic mb-4">
            [Lester et al., 2021, p.3]
          </p>

          <p className="text-slate-700 mb-2 mt-6">
            <strong>GPT-3 175B on WikiSQL:</strong>
          </p>
          <div className="overflow-x-auto mb-4">
            <table className="min-w-full bg-slate-50 rounded-lg">
              <thead>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-50 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-slate-700 text-sm">
                ...
                <li>✅ No architectural changes</li>
                <li>
                  ❌ Requires very large models (&gt;10B) for best results
                </li>
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-slate-700 text-sm">
                ...
                <li>
                  ✅ Highest parameter efficiency among weight-based methods
                </li>
          ...
          <p className="text-slate-700 text-sm italic mt-4">
            [Hu et al., 2021, p.3-5; Lester et al., 2021, p.1-7]
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-700 mb-4">
            Pre-trained language models have low "intrinsic dimension" - they
            can learn efficiently even when constrained to a random
            low-dimensional subspace (Aghajanyan et al., 2020).
          </p>
          <p className="text-slate-700 mb-2">
          ...
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li>
              <strong>The changes needed for adaptation</strong> also lie in a
            ...
            <li>
              Task-specific adaptation requires relatively few degrees of
              freedom
            </li>
          </ul>
          <p className="text-slate-700 text-sm italic mb-4">
          ...
          <p className="text-slate-700 mb-2">
            Large pre-trained models are heavily over-parametrized for any
            single downstream task. PEFT methods effectively:
          </p>
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li>Use the pre-trained weights as a powerful feature extractor</li>
            <li>Add minimal task-specific capacity on top</li>
            <li>
              Avoid overfitting that can occur with full fine-tuning on small
              datasets
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-700 mb-2">
            <strong>When full fine-tuning might be better:</strong>
          </p>
          <ul className="list-disc list-inside space-y-1 ml-4 text-slate-700 mb-4">
            <li>Single task deployment</li>
            <li>
              Extremely different task from pre-training (e.g., different
              language)
            </li>
          ...
          <ol className="list-decimal list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li>
              <strong>Inference Latency:</strong> Use LoRA or Prefix methods if
              latency is critical
            </li>
            <li>
              <strong>Parameter Budget:</strong> LoRA offers best performance
              per parameter
            </li>
            <li>
              <strong>Ease of Implementation:</strong> BitFit is simplest,
              Prefix methods next, then LoRA and Adapters
            </li>
            <li>
              <strong>Stability:</strong> LoRA and Adapters more stable than
              Prefix methods
            </li>
            <li>
              <strong>Low-Data Performance:</strong> LoRA significantly
              outperforms others
            </li>
          </ol>
          <p className="text-slate-700 text-sm italic">
        ...
        <section>
          ...
          <p className="text-slate-700 mb-4">
            Imagine your pre-trained model is like a massive general hospital
            with thousands of expert doctors, nurses, and equipment
            (parameters). You want to adapt it for specialized clinics -
            cardiology, pediatrics, orthopedics, etc.
          </p>
          <div className="space-y-4">
            <div className="bg-red-50 rounded-lg p-4">
              ...
              <p className="text-slate-700 text-sm">
                Building entirely new hospitals for each specialty, each with
                thousands of staff. Expensive and wasteful since most medical
                knowledge overlaps.
              </p>
            </div>
            <div className="bg-yellow-50 rounded-lg p-4">
              ...
              <p className="text-slate-700 text-sm">
                Hiring a small specialist team for each clinic that works
                alongside the general hospital staff. Works well, but the
                specialist team has to be consulted sequentially, adding time to
                each patient visit.
              </p>
            </div>
            <div className="bg-purple-50 rounded-lg p-4">
              ...
              <p className="text-slate-700 text-sm">
                Creating special intake questionnaires that prime the general
                hospital for each specialty. Simple, but takes up space in the
                waiting room and doesn't always work reliably.
              </p>
            </div>
            <div className="bg-green-50 rounded-lg p-4">
              <p className="font-semibold text-green-900 mb-2">LoRA:</p>
              <p className="text-slate-700 text-sm">
                Training a handful of general hospital staff to adjust their
                techniques slightly for each specialty. The adjustments are so
                seamless that when a patient arrives, it's as if the hospital
                was always specialized for that condition - no extra waiting
                time, minimal extra training needed.
              </p>
            </div>
          </div>
          <p className="text-slate-700 mt-4">
            The key insight: The general hospital already knows most of what's
            needed. You just need small, strategic adjustments, not entirely new
            facilities.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-700 mb-4">
            <strong>Example: 100 Task Adaptation for GPT-3 175B</strong>
          </p>
          <div className="overflow-x-auto mb-4">
            <table className="min-w-full bg-slate-50 rounded-lg">
              <thead>
          ...
          <p className="text-slate-700 mb-4">
            <strong>GPT-3 175B with Adam Optimizer:</strong>
          </p>
          <div className="overflow-x-auto mb-4">
            <table className="min-w-full bg-slate-50 rounded-lg">
              <thead>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4 text-slate-700 mb-4">
            ...
            <li>
              Facilitates sharing of adapted models (small LoRA weights vs. full
              models)
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 ml-4 text-slate-700 mb-4">
            <li>
              <strong>Optimal Selection:</strong> More principled methods for
              choosing which parameters/layers to adapt
            </li>
            <li>
              <strong>Theoretical Understanding:</strong> Better formal
              understanding of why low-rank/sparse updates suffice
            </li>
            <li>
              <strong>Combination Methods:</strong> How to optimally combine
              different PEFT approaches
            </li>
            <li>
              <strong>Task Relationships:</strong> How to leverage relationships
              between tasks in multi-task PEFT
            </li>
            <li>
              <strong>Automatic Configuration:</strong> Methods to automatically
              determine optimal rank/adapter size per task
            </li>
          </ol>
          <p className="text-slate-700 text-sm italic">
            [Hu et al., 2021, p.13]
